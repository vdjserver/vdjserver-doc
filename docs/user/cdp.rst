...
1. (Price: $3500) Upload data to an Amazon S3 bucket. 
...
2. (Price: $3500) FEDEX/UPS a hard disk drive with the data to the customer.
...
3. (Price: $5000) Both options 1 and 2.
